...
# CLS 250401 - The following were duplicated constants from the calendar attributes - Changed to be unique, but may want to handle differently
SENSOR_ATTR_CAL_ALL_DAY = "all_day"
SENSOR_ATTR_CAL_DESCRIPTION = "description"
SENSOR_ATTR_CAL_END = "end"
SENSOR_ATTR_CAL_MANUFACTURER = "manufacturer"
SENSOR_ATTR_CAL_START = "start"
SENSOR_ATTR_CAL_SUMMARY = "summary"
